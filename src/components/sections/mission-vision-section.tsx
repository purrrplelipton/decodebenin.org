...
export function MissionVisionSection() {
  ...
  return (
    ...
    >
      ...
      >
        <img
          src="/images/mission-in-action-roadmap-clarity.avif"
      ...
      >
        <img
          src="/images/vision-future-tech-leaders.avif"
      ...
      >
        <img
          src="/images/values-in-practice-collaboration.avif"
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-4 md:px-6">
        ...
        <AnimateInView
          ...
          delay={300}
          duration={700}
          className="scrapbook-card relative mx-auto mt-12 max-w-3xl rounded-lg bg-card p-6 text-center md:mt-16 md:p-8"
        >
          <div
